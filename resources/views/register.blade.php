    ...
    <div class="d-md-flex w-100 h-100 justify-content-around align-items-center">
        ...
        <div class="col-md-6 col-sm-12 mb-md-0 mb-3">
            <div class="block-2">
                ...
                <p class="text-white">
                    <b>Логин</b> (твой логин будет отображаться на глобальной карте, поэтому советуем сохранять свою
                    анонимность)<br>
                    ...
                    <small>Какова твоя мотивация и откуда ты узнал/-а о Фонде: Ұ140 символов макс.</small>
                </p>
